...
page.open(system.env.PAGE, function(status) {
	if (status === 'success' && page.injectJs("node_modules/jquery/dist/jquery.js")) {
		var urls = page.evaluate(function() {
			...
			var urls = {};
			['xvideos.com', 'm.xvideos.com', 'xnxx.com', 'multi.xnxx.com', 'm.xnxx.com'].forEach(function(url){
					urls[url] = 1;
